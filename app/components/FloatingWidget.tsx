        ...
        <div style={{ position: "relative", width: "56px", height: "56px" }}>
            ...
            return (
              <a
                ...
                style={{
                  ...
                  boxShadow: "0 4px 12px rgba(12,13,16,0.6)",
                }}
                title={opt.tooltip}
              >
                {opt.icon}
          ...
          <button
            ...
            style={{
              ...
              height: "56px",
              borderRadius: "50%",
              background: (isOpen || isChatOpen) ? "rgba(255,176,32,0.15)" : "var(--amber)",
              color: (isOpen || isChatOpen) ? "var(--amber)" : "var(--bg)",
              border: (isOpen || isChatOpen) ? "1px solid var(--amber)" : "1px solid transparent",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              cursor: "pointer",
              boxShadow: (isOpen || isChatOpen) ? "none" : "0 8px 24px rgba(255,176,32,0.25)",
